...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((9_466_000 as Weight).saturating_mul(c as Weight))
	}
	fn as_derivative() -> Weight {
		(18_047_000 as Weight)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		(42_359_000 as Weight)
			// Standard Error: 113_000
			.saturating_add((9_801_000 as Weight).saturating_mul(c as Weight))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		(29_582_000 as Weight)
			...
			.saturating_add((9_726_000 as Weight).saturating_mul(c as Weight))
	}
}
