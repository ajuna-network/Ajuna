...
impl<T: frame_system::Config> WeightInfo for AjunaWeight<T> {
	...
	fn mint_free(n: u32, ) -> Weight {
		// Minimum execution time: 183_637 nanoseconds.
		Weight::from_ref_time(220_168_923 as u64)
			// Standard Error: 104_723
			.saturating_add(Weight::from_ref_time(605_958 as u64).saturating_mul(n as u64))
	...
	/// The range of component `n` is `[0, 94]`.
	fn mint_normal(n: u32, ) -> Weight {
		// Minimum execution time: 218_774 nanoseconds.
		Weight::from_ref_time(308_666_082 as u64)
			// Standard Error: 164_730
			.saturating_add(Weight::from_ref_time(33_980 as u64).saturating_mul(n as u64))
	...
	fn forge(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(201_240_854 as u64)
			// Standard Error: 102_361
			.saturating_add(Weight::from_ref_time(1_169_389 as u64).saturating_mul(n as u64))
	...
	fn transfer_avatar_normal(_n: u32, ) -> Weight {
		// Minimum execution time: 162_585 nanoseconds.
		Weight::from_ref_time(316_891_084 as u64)
	...
	fn transfer_avatar_organizer(_n: u32, ) -> Weight {
		// Minimum execution time: 167_561 nanoseconds.
		Weight::from_ref_time(274_859_840 as u64)
			.saturating_add(T::DbWeight::get().reads(8 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	// Storage: AwesomeAvatars GlobalConfigs (r:1 w:0)
	...
	fn transfer_free_mints() -> Weight {
		// Minimum execution time: 49_751 nanoseconds.
	...
	fn set_price() -> Weight {
		// Minimum execution time: 82_799 nanoseconds.
		Weight::from_ref_time(112_095_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	fn remove_price() -> Weight {
		...
		Weight::from_ref_time(103_700_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: AwesomeAvatars GlobalConfigs (r:1 w:0)
	...
	/// The range of component `n` is `[1, 100]`.
	fn buy(n: u32, ) -> Weight {
		// Minimum execution time: 172_653 nanoseconds.
		Weight::from_ref_time(232_900_234 as u64)
			// Standard Error: 109_848
			.saturating_add(Weight::from_ref_time(901_942 as u64).saturating_mul(n as u64))
	...
	// Storage: AwesomeAvatars Treasury (r:1 w:1)
	fn upgrade_storage() -> Weight {
		// Minimum execution time: 82_540 nanoseconds.
		Weight::from_ref_time(83_361_000 as u64)
	...
	fn set_organizer() -> Weight {
		...
		Weight::from_ref_time(29_648_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: AwesomeAvatars Treasurer (r:0 w:1)
	fn set_treasurer() -> Weight {
		// Minimum execution time: 28_221 nanoseconds.
		Weight::from_ref_time(29_176_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: AwesomeAvatars Organizer (r:1 w:0)
	// Storage: AwesomeAvatars Seasons (r:1 w:1)
	fn set_season() -> Weight {
		// Minimum execution time: 47_013 nanoseconds.
		Weight::from_ref_time(71_299_000 as u64)
	...
	// Storage: AwesomeAvatars Accounts (r:1 w:1)
	fn issue_free_mints() -> Weight {
		// Minimum execution time: 42_861 nanoseconds.
		Weight::from_ref_time(90_261_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: AwesomeAvatars Organizer (r:1 w:0)
	...
	fn withdraw_free_mints() -> Weight {
		...
		Weight::from_ref_time(96_528_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: AwesomeAvatars Organizer (r:1 w:0)
	...
	fn set_free_mints() -> Weight {
		...
		Weight::from_ref_time(40_719_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
