...
impl<T: frame_system::Config> WeightInfo for AjunaWeight<T> {
	...
	/// Storage: `AwesomeAvatars::CurrentSeasonStatuses` (r:1 w:1)
	/// Proof: `AwesomeAvatars::CurrentSeasonStatuses` (`max_values`: None, `max_size`: Some(11), added: 2486, mode: `MaxEncodedLen`)
